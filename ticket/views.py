...
from .serializers import TicketCreateSerializer, TicketRetrieveSerializer
# , TicketSerializer
...
class TicketViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Ticket.objects.filter(user=user).all()  # Get all tickets

    def get_serializer_class(self):
        if self.action in ['create']:
            return TicketCreateSerializer  # Use the create serializer for creation
