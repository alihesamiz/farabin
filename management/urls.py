...
from management.views import ChartNodeViewSet, HumanResourceViewSet, OrganizationChartFileViewSet, PersonelInformationViewSet, SWOTMatrixViewSet, SWOTOptionViewSet, SWOTQuestionViewSet
...
router.register(r"swot/questions", SWOTQuestionViewSet,
                basename="swot-questions")
router.register(r"swot-options", SWOTOptionViewSet,
                basename="swot-options")


hr_nested_router = NestedDefaultRouter(
    router, r'human-resources', lookup='human_resource')
hr_nested_router.register(r'personel', PersonelInformationViewSet,
                          basename='human-resource-personel')
hr_nested_router.register(r'graph', ChartNodeViewSet,
