...
from apps.request.models import FinanceRequest, ManagementRequest

from apps.company.models import CompanyService
...
def create_finance_request(sender, instance, created, **kwargs):
    if created:
        ...
        finance_request_data = {
            ...
            "service": service,
            "subject": "در صورت عدم تایید محتوای ارسال شده، علت را اینجا وارد کنید.",
        }
